...
# Palabras clave para identificar eventos de calificación crediticia
...
for idx, (emisor, prod) in enumerate(mapping_emisores.items()):
    ...
    try:
        ...
        for item in root.findall('.//item')[:4]:  # Evaluamos los primeros 4 resultados
...
# ORDENACIÓN INTERNA: Mover alertas prioritarias al inicio de cada lista
...
for producto in orden_productos:
    ...
    for emisor, contenido in emisores_del_producto.items():
        ...
        # Resaltar la caja entera si tiene una alerta crítica de calificación de riesgo
